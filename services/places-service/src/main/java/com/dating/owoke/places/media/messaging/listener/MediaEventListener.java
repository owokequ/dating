package com.dating.owoke.places.media.messaging.listener;
...
import com.dating.owoke.places.media.messaging.service.MediaEventProcessor;
...
import com.dating.owoke.places.shared.messaging.repository.FailedMessageRepository;
...
public class MediaEventListener {
    ...
    private final MediaEventProcessor processor;
    ...
    @KafkaListener(topics = "media.events.v1")
