...
import com.dating.owoke.media.collection.messaging.service.EventEventProcessor;
...
public class EventEventListener {
    ...
    private final EventEventProcessor processor;
    private final FailedMessageRepository failedRepository;
    private final ObjectMapper objectMapper;
    private final Clock clock;

    public EventEventListener(
            EventEventProcessor processor,
    ...
    public void onDlt(String message, @Header("kafka_receivedTopic") String topic) {
        ...
        failedRepository.save(new FailedMessage(
                envelope == null ? null : envelope.eventId(), topic,
                envelope == null ? null : envelope.eventType(), message,
                "Kafka retries exhausted", clock.instant()));
    }
