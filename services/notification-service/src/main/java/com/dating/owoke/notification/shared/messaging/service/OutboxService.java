...
import com.dating.owoke.notification.shared.messaging.domain.OutgoingEventEnvelope;
import com.dating.owoke.notification.shared.messaging.repository.OutboxEventRepository;
...
public class OutboxService {
    ...
    public UUID enqueue(String topic, String eventKey, String eventType, Object payload) {
        ...
        OutgoingEventEnvelope envelope = new OutgoingEventEnvelope(
